...
const StationOverviewPage = (): React.ReactElement => {
    ...
    return (
        <div className="flex flex-col justify-center items-center h-[calc(100dvh-60px)]">
            <div className="w-[500px] p-8 border border-black border-opacity-15 dark:border-neutral-800 rounded-xl overflow-hidden">
                <p className="text-4xl font-semibold">Add a new charger</p>
                <p className="text-md font-normal dark:font-light opacity-60">Insert the 6 digit code visible on the screen</p>
